        ...
        this.btn_basket_new.addActionListener(e -> {
            ...
            if(selectedCustomer==null) {
                ...
                if(customer.getId()==0) {
                    ...
                    Helper.showMessage("Lütfen sepete bir ürün ekleyin.");
                } else {
    ...
    private void loadProductPopupMenu() {
        ...
        this.popup_product.add("Sepete Ekle").addActionListener(e -> {
            ...
            if(basketProduct.getStock() <=0) {
                Helper.showMessage("Bu ürün stokta bulunmamakta.");
            } else {
       ...
       tbl_product.setComponentPopupMenu(this.popup_product);
    }
